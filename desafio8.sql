select ContactName as 'Nome de contato', ship.ShipperName as 'Empresa que fez o envio', ord.OrderDate as 'Data do pedido' from w3schools.customers as cust
...
order by `Nome de contato`, `Empresa que fez o envio`, ord.OrderDate;
