...
ELSE 'CEO'
END AS 'Senioridade' FROM hr.jobs INNER JOIN hr.employees ON employees.JOB_ID = jobs.JOB_ID
GROUP BY JOB_TITLE ORDER BY ROUND(AVG(employees.SALARY), 2) ASC, JOB_TITLE ASC;
