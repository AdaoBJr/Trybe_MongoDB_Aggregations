-- 4 - Exiba a média salarial e o nível de senioridade de todas as pessoas empregadas,
...
-- -A segunda deve possuir o alias "Média salarial" e exibir a média dos salários das pessoas 
-- empregadas que possuem o cargo em questão.
-- -A terceira deve possuir o alias "Senioridade" e categorizar o nível de senioridade do 
-- cargo com base na média salarial, da seguinte forma:
...
-- *Em caso de empate na média, os resultados devem ser ordenados pelo nome do cargo em
-- ordem alfabética.
