...
-- Exiba todos os produtos que já foram pedidos e que possuem uma média de
--  quantidade nos pedidos registrados acima de 20.00.
-- Use o banco w3schools como referência
-- Monte uma query que exiba 04 colunas:
-- A primeira deve possuir o alias "Produto" e exibir o nome do produto.
-- A segunda deve possuir o alias "Mínima" e exibir a quantidade mínima que
--  já foi pedida desse produto.
-- A terceira deve possuir o alias "Máxima" e exibir a quantidade máxima que
--  já foi pedida desse produto.
-- A quarta deve deve possuir o alias "Média" e exibir a média de quantidade
...
-- Em caso de empate na média, os resultados devem ser ordenados pelo nome
