...
-- -A terceira deve possuir o alias "Data de início do cargo" e exibir a data que a pessoa
--  iniciou o cargo.
-- -A quarta deve possuir o alias "Departamento" e mostrar o nome do departamento em que a
--  pessoa exerceu seu cargo.
-- -Os resultados devem estar ordenados pelo nome completo das pessoas empregadas
