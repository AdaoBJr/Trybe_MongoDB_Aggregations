SELECT CONCAT(emplo.FIRST_NAME, ' ', emplo.LAST_NAME) AS "Nome completo",
...
INNER JOIN jobs ON job_h.JOB_ID = jobs.JOB_ID
INNER JOIN departments AS depart ON job_h.DEPARTMENT_ID = depart.DEPARTMENT_ID
