select CONCAT(FIRST_NAME,' ', LAST_NAME) AS 'Nome completo', j.JOB_TITLE as 'Cargo', hist.START_DATE as 'Data de início do cargo',  dep.DEPARTMENT_NAME as 'Departamento' from hr.employees as emplo
